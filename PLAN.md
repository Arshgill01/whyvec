...
| R5 | Build-causality query | active | Cargo/rustc diagnostic identity, nested file-to-hunk search, isolated worktrees, removal witnesses, CLI, semantic replay, and mandatory fingerprinted Bubblewrap containment execute; syntax-aware grouping remains |
