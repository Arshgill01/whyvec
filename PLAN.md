...
| R4 | LLVM optimization-causality pack | active | LLVM 21 API transformer applies and verifies typed parameter `noalias` with exact-delta/refusal tests; exact pipeline replay, retained query reports, and stable region identity remain |
