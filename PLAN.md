...
| R4 | LLVM optimization-causality pack | active | LLVM 21 API transformer and replay of Clang's recorded printable pipeline reproduce the baseline miss and typed variant vectorization with `equivalent_confirmed` fidelity; retained query reports and stable region identity remain |
