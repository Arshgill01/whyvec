...
| R7 | Source-action, validation, and measurement | active | The first C affine pointer-bound model derives a replayable candidate obligation and refuses volatile semantics; guarded source action, differential validation, sanitizer evidence, and retained measurement remain |
